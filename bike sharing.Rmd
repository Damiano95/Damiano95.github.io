...
# trasformazione della variabile data in 4 diverse variabili: ora, mese, anno e giorno della settimana
train %>% 
...
# rimozione della variabile data
train<-train[,-1]
test<-test[,-1]
...
# creazione di due ulteriori variabili categoriali per l'ora (divise per le due diverse risposte, registered e casual)
# le divisioni sono state fatte manualmente con l'ausilio dei boxplot e di un albero di regressione
...
# creazione di due ulteriori variabili categoriali per la temperatura dell'aria (divise per le due diverse risposte, registered e casual)
# le divisioni sono state fatte manualmente con l'ausilio dei boxplot e di un albero di regressione
...
# creazione di una variabile categoriale che divida l'anno in varie parti ma, a differenza della variabile season, tenga anche conto del fatto che nel 2012 il numero di affitti è aumentato 
# le divisioni sono state fatte manualmente con l'ausilio dei boxplot 
combi$div.year<-0
...
# creazione di una variabile categoriale che unisca le informazioni delle variabili holiday e workingday
combi$day.type=0
...
# creazione di una dummy che indichi se il giorno fa parte del weekend o meno
combi$weekend = 0
...
# la griglia usata per il tuning è messa come commento perché ci mette un tempo elevatissimo a fornire i risultati
...
# (più in basso si trova la griglia effettivamente usata)
